...
func (_q *LanguageQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *LanguageQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *LanguageQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *LanguageQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *LanguageQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *LanguageQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LanguageQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(language.Table, language.Columns, sqlgraph.NewFieldSpec(language.FieldID, field.TypeInt64))
	_spec.From = _q.sql
